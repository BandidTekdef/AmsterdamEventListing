...
(function(factory){
	...
	var Datepicker = function(element, options){
		...
		if (this.o.calendarWeeks) {
			this.picker.find('.datepicker-days .datepicker-switch, thead .datepicker-title, tfoot .today, tfoot .clear, tfoot .confirm')
      ...
      var localDate = this._utc_to_local(this.viewDate);
		...
		fill: function(){
			var d = new Date(this.viewDate),
				...
				confirmtxt = dates[this.o.language].confirmtxt || dates['en'].confirm || '',
        ...
        titleBtnVisible = (this.o.todayBtn === true || this.o.todayBtn === 'linked') && todayDate >= this.o.startDate && todayDate <= this.o.endDate && !this.weekOfDateIsDisabled(todayDate),
			...
			this.picker.find('tfoot .confirm')
						.text(confirmtxt)
						.css('display', this.o.confirmBtn === true ? 'table-cell' : 'none');
	...
	var DPGlobal = {
		...
		footTemplate: '<tfoot>'+
							...
							'<tr>'+
								...
								'<th colspan="4" class="confirm"></th>'+
							'</tr>'+
							'</tfoot>',
		fakeTemplate: '<div class="widget-content">' +
